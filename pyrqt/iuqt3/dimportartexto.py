...
from Driza.iuqt3.ui.dimportartexto import DialogoImportarTexto
from qt import QFileDialog, SIGNAL, QMessageBox, QString
import logging
LOG = logging.getLogger("Driza.iuqt3.dimportartexto")


class DImportarTexto(DialogoImportarTexto):
    """
    ...
    def __init__(self, parent, interfazdatosfichero):
        """Inicialización"""
        DialogoImportarTexto.__init__(self, parent, "dialogo importar texto", \
                0, 0)
