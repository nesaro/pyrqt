...
class VPrincipal(QMainWindow):
    ...
    def __init__(
        ...
        listaelementosmenu = self.__lista_etiquetas_menu(
            self.__diccionarioarbolmenu, []
        )
    ...
    def abrir_proyecto(self, parent=None, filename=None):
        ...
        from pyrqt.excepciones import (
            FicheroNoExisteException,
            FicheroErroneoException,
        ...
        if filename:
            try:
                ...
                QMessageBox.warning(
                    parent, "Atención", "El fichero no ha podido ser leido"
                )
                ...
                QErrorMessage(parent, "Error").message(
                    "Parece que ha intentado cargar un fichero de una versión anterior. Lo siento"
                )
    ...
    def __dacerca_de(self):
        ...
        separador = "<hr>"
        ristra = "<html>"
        betatesters = "Carlos Mestre Gonzalez <br> Luis de Bethencourt Guimerá"
        iconos = "Iconos del Tango Desktop Project: http://tango.freedesktop.org/"
        ristra += (
            "pyrqt %s es una interfaz estadística <br> (C) Néstor Arocha Rodríguez - Tutorizado por Inmaculada luengo Merino<br> Distribuido bajo licencia GPL"
            + separador
            + "Betatesters:\n"
            + betatesters
            + separador
    ...
    def __copiar(self):
        ...
        try:
            ...
            QMessageBox.warning(
                self,
                "Atención",
                "Las operaciones de copiado, cortado y pegado no han sido implementadas",
            )
        else:
    ...
    def __cortar(self):
        ...
        try:
            ...
            QMessageBox.warning(self, "Atención", "Solo se permite cortar registros")
        except AssertionError:
            QMessageBox.warning(
                self,
                "Atención",
    ...
    def __pegar(self):
        ...
        try:
            ...
            QErrorMessage(self, "Error").message("Error desconocido")
    ...
    def __conv_arbol_menu(self, padre, arbol, diccionario):
        ...
        for hijo in arbol.enlaces:
            nuevarama = QMenu(str(hijo.contenido), self)
