...
class DBuscar(QDialog):
    ...
    def __buscar(self):
        ...
        if resultado:
            ...
            self.accept()
            return
        codigoretorno = QMessageBox.warning(
            self,
            "Atencion",
    ...
    def __conexiones(self):
        ...
        # TODO new signal syntax
        # self.connect(self.ui.pushButton1,pyqtSignal("clicked()"),self.__buscar)
        # self.connect(self.ui.pushButton2,pyqtSignal("clicked()"),self.reject)
