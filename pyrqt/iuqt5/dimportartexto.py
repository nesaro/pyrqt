...
from pyrqt.iuqt5.ui.dimportartexto import Ui_DialogoImportarTexto
from PyQt5 import QtCore, QtGui
from PyQt5.QtCore import pyqtSignal
from PyQt5.QtWidgets import QDialog


class DImportarTexto(QDialog):
    """
    ...
    def accept(self):
        ...
        try:
            ...
            self.__idf.cargar_texto(
                self.archivo, delimitadoratrib=delatr, cabeceras=cabecera
            )
        except RException:
            msg = "R No pudo importar el fichero"
    ...
    def __conexiones(self):
        ...
        self.connect(
            self.ui.pushButton1, pyqtSignal("clicked()"), self.__seleccionar_fichero
        )
    ...
    def __seleccionar_fichero(self):
        ...
        cadenaarchivo = str(
            QtGui.QFileDialog.getOpenFileName(None, "importar fichero", filtro, "")
        )
        if cadenaarchivo:
