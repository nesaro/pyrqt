...
from pyrqt.iuqt5.ui.dsplash import Ui_DialogoSplash
...
class DSplash(QDialog):
    ...
    def __enlace(self, parametro):
        ...
        if parametro == "nuevo":
            ...
            if self.parent().abrir_proyecto(
                self, self.__config.configuracion["lfichero"][eval(str(parametro))]
            ):
                self.accept()
