...
class WidgetSeleccionCajaCaja(QWidget):
...
class WidgetSeleccionCajaComboComboCajaCaja(QHBoxLayout):
    """Widget con dos zonas"""
...
class WidgetSeleccionCajaComboComboCaja(QFrame):
    """Widget con dos zonas"""
